    ...
    <div className="flex flex-col h-full">
      <div className="px-6 py-4 border-b border-slate-800/60 flex-shrink-0">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="font-display text-xl font-bold text-white">Safety</h1>
            <p className="text-slate-500 text-xs mt-0.5">Safety monitoring — Big V's Best Routes™ · Advisory outputs only · Human override required</p>
          </div>
          <div className="flex items-center gap-2">
            {critical > 0 && (
        ...
        {/* ── Big V's Best Routes™ Safety Advisory ── */}
        <div className="flex items-start gap-2.5 px-3 py-2.5 rounded-lg border border-amber-500/20 bg-amber-500/5 mb-4">
          ...
          <p className="text-2xs text-slate-400 leading-relaxed">
            <span className="text-amber-300 font-semibold">Advisory only.</span> Safety AI outputs are advisory only. Drivers, fleet managers, and controllers remain responsible for final operational decisions. Human override required at all times.
          </p>
        </div>
        {/* Stats */}
