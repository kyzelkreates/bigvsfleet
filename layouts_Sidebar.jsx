      ...
      <div className="flex items-center gap-3">
        <div className="relative flex-shrink-0">
          <div className="w-8 h-8 bg-amber-500/10 border border-amber-500/30 rounded flex items-center justify-center">
            <span className="font-display font-bold text-amber-400 text-xs tracking-wider">BV</span>
          </div>
        ...
        <div className="min-w-0">
          ...
          <div className="text-slate-500 text-2xs tracking-widest uppercase">Safety & Legal Compliance First</div>
        </div>
      </div>
      {/* Close X */}
      <button
...
function SidebarFooter() {
  return (
    <div className="px-3 py-3 border-t border-slate-800/60 space-y-1.5">
      ...
      <div className="text-2xs text-slate-800 leading-tight px-0.5">
        Safety & Legal Compliance First
      </div>
      <div className="text-2xs text-slate-800 leading-tight px-0.5">
        4P3X Intelligent AI™ · Kyzel Kreates™
      </div>
    </div>
  )
}
...
export default function Sidebar() {
  ...
  return (
    ...
    >
      ...
      {/* Quick launch shortcuts — fleet ops */}
      <div className="px-3 pb-2 space-y-1.5">
        <a href="#/app/driver-setup" className="flex items-center gap-2 px-3 py-2.5 rounded-xl border border-violet-500/25 bg-violet-500/8 hover:bg-violet-500/15 transition-colors group">
        ...
        <a href="#/fleet-controller-pwa" className="flex items-center gap-2 px-3 py-2.5 rounded-xl border border-emerald-500/20 bg-emerald-500/5 hover:bg-emerald-500/10 transition-colors group">
          <Icon name="Tablet" size={14} className="text-emerald-400 flex-shrink-0" />
          <span className="text-xs font-semibold text-emerald-300 flex-1">Fleet Controller PWA</span>
          <Icon name="ChevronRight" size={11} className="text-emerald-700 group-hover:text-emerald-400 transition-colors" />
        </a>
      </div>
