...
import { ComplianceAIPanelPair } from './components_ui_ComplianceAIPanels'
    ...
    <div className="flex flex-col h-full">
      <div className="px-6 py-4 border-b border-slate-800/60 flex-shrink-0">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="font-display text-xl font-bold text-white">Compliance</h1>
            <p className="text-slate-500 text-xs mt-0.5">Advisory compliance tracking — Big V's Best Routes™ · 4P3X Intelligent AI™ Created by Kyzel Kreates™</p>
          </div>
        ...
        {/* ── Big V's Best Routes™ Advisory Disclaimer ── */}
        <div className="flex items-start gap-2.5 px-3 py-2.5 rounded-lg border border-amber-500/20 bg-amber-500/5 mb-4">
          ...
          <p className="text-2xs text-slate-400 leading-relaxed">
            <span className="text-amber-300 font-semibold">Advisory only.</span> Compliance AI provides guidance only. Drivers, fleet managers, and controllers remain responsible for checking current laws, signage, permits, restrictions, road conditions, and company policy before travel. The system does not guarantee legal route compliance.
          </p>
        </div>
        {/* ── RUN 9: 4P3X Intelligent AI Oversight Panels ── */}
        <div className="mb-5">
          <ComplianceAIPanelPair />
        </div>
